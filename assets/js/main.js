...
(function () {
  ...
  if (propertiesSection) {
    const viewButtons = propertiesSection.querySelectorAll(".view-btn");
    const gridView = propertiesSection.querySelector(".properties-grid");
    const listView = propertiesSection.querySelector(".properties-list");
